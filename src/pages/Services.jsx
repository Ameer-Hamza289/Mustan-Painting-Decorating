          ...
          <div className="col-md-6 col-12 p-5 bg-secondary text-white">
            ...
            <div className="my-4">
              <p className="mt-3">
                ...
                at every stage to make sure you are happy with the outcome in
                the finish.
              </p>
              <p style={{ marginTop: "2rem" }}>
                ...
                it. Whether you want to just brighten up a tired-looking façade
                or want to give the interiors of your home a makeover, our
            ...
            <div className="my-5 pt-4 ">
              ...
              <hr />
              <p>
                We are aware that commercial business frequently requires
                working after hours and has tight deadlines, at Perth Painting &
                Deco, we are aware of this. Thanks to our considerable expertise
                dealing with a wide range of clients in a variety of industries,
                you can depend on us to accomplish a painting job just as you
                imagined it.
              </p>
              <p>
                ...
                extra time on the weekends and on holidays. Contact us right
                away for solutions that truly showcase the brilliance of your
                business and brand.
              </p>
            </div>
            <div className="my-5 pt-4 pb-lg-5  ">
              ...
              <p>
                ...
                improve the appearance of the interior of your home is to build
                a feature wall. Whatever feature wall you decide on, you will
                love the wonderful advantages that come with it.
              </p>
              <p>
                You have a wonderful opportunity with feature walls to
                experiment with contrasting colours, forms, textures, and
                patterns that precisely suit your preferences. This is one of
                the quickest and cheapest ways you can immediately brighten up
                your area.
              </p>
              <p>
