  ...
  return (
    <div className=" row m-0 py-4">
      <div className="col-md-7 col-12 d-flex flex-wrap px-0">
        <div
          className="col-6 HomeService d-flex align-items-center justify-content-center "
        ...
        <div
          className="col-md-6 Service1Home d-flex align-items-center justify-content-center "
          style={{ minHeight: "300px" }}
        >
        ...
        <div
          className="col-md-6 HomeService d-flex align-items-center justify-content-center"
          style={{ minHeight: "300px" }}
        >
      ...
      <div className="col-md-5 col-12 px-5">
