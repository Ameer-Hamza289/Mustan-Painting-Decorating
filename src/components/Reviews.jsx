...
const Reviews = () => {
  return (
    <>
      <div className="py-5 " style={{ paddingInline: "70px" }}>
        <p className="fw-bold mb-0 lh-1" style={{ fontSize: "46px" }}>
          WHAT PEOPLE ARE SAYING
        </p>
        <p className="fw-bold" style={{ fontSize: "46px" }}>
          ABOUT US...
        </p>
      </div>
      <div className="Service1Home" style={{ paddingBlock: "80px", paddingInline:"20px" }}>
        <div className="row">
          <div className="col-md-4 col-12 " style={{ padding:"0px 50px" }}>
