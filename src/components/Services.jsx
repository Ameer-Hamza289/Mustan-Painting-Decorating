    ...
    <div className="row HomeService m-0">
            <div className="col-4 py-5  " style={{ paddingInline: "80px" }}>
              ...
              <p className="mt-4" style={{ fontSize: "20px" }}>
                Perth Painting & Deco is a family-run painting business located
                in Perth, Western Australia. We offer residential, commercial
                and feature wall painting services using our qualified painters.
              </p>
              <p className="mt-4" style={{ fontSize: "20px" }}>
              ...
              <div className="col-12">
                <div className="col-6 Service1Home p-5 pb-4">
                  ...
                  <p style={{ fontSize: "18px", marginTop: "20px" }}>
                    Whether you simply want to brighten up a worn-out exterior
                    or want to give the inside of your home a makeover, our
                    residential painting service will deliver the highest
