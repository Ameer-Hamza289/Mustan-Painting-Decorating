    ...
    <div className="row m-0 z-0 HomeService ">
            <div className="col-6 " style={{ padding: "60px 75px" }}>
              ...
              <p className="my-5 fs-5">
                Perth Painting & Deco is a team of professional painters serving
                the Perth metro area.{" "}
              </p>
              <p className="fs-5">
                With over 12 years of experience, you can rely on Perth Painting
                & Deco to complete any upcoming residential, commercial, or
